...
import type { Tweet } from '@lib/types/tweetCommunities';
  ...
  return (
    ...
    >
      ...
      {reply && visited && (
        ...
        >
          Replying to{' '}
          <span className='custom-underline text-main-accent cursor-pointer' onClick={handleOpenProfileModal}>
      ...
      {isProfileModalOpen && (
        <div
          className='CloseBtun122divclassName menu-container  inset-0 flex items-center justify-center'
          onClick={handleCloseProfileModal}
        >
          <div
            className='bg-white p-6 rounded-lg w-[400px] h-[150px] text-center'
            onClick={(e) => e.stopPropagation()}
          >
            <p>Username: {parent?.username}</p>
            <button
              className='CloseBtun122'
              onClick={handleCloseProfileModal}
            >
              Close
            </button>
...
// import { toast } from 'react-hot-toast';
// import { addDoc, getDoc, serverTimestamp } from 'firebase/firestore';
// import { communitiesCollection, tweetsCollection } from '@lib/firebase/collections'; // Update to include communities
// import {
//   manageReply,
//   uploadImages,
//   manageTotalTweets,
...
//   replyModal?: boolean;
//   closeModal?: () => void;
//   communityId: string; // New prop to ensure post is created for a specific community
// };
...
//   replyModal,
//   closeModal,
//   communityId // Ensure we have the community ID available here
// }: InputProps): JSX.Element {
//   const [selectedImages, setSelectedImages] = useState<FilesWithId>([]);
//   const [imagesPreview, setImagesPreview] = useState<ImagesPreview>([]);
//   const [inputValue, setInputValue] = useState('');
...
//     // Ensure the post is created for a specific community
//     const tweetData: WithFieldValue<Omit<Tweet, 'id'>> = {
//       text: inputValue.trim() || null,
//       parent: isReplying && parent ? parent : null,
//       images: await uploadImages(userId, selectedImages),
...
//       () => (
//         <span className='flex gap-2'>
//           Your Post was sent to the community
//           <Link href={`/community/${communityId}/post/${tweetId}`}>
//             <a className='custom-underline font-bold'>View</a>
//           </Link>
//         </span>
//       ),
