...
type InputProps = {
  ...
  replyModal?: boolean;
  closeModal?: () => void;
  groupId?: string; // Added groupId prop to specify the target group
};
...
export function Input({
  ...
  replyModal,
  closeModal,
  groupId // Used groupId to post specifically to a group
  ...
  const sendGroupPost = async (): Promise<void> => {
    ...
    const tweetData: WithFieldValue<Omit<Tweet, 'id'>> = {
      ...
      userReplies: 0,
      userRetweets: [],
      groupId // Specify the groupId for the post
    };
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>): void => {
    e.preventDefault();
    void sendGroupPost(); // Changed function call
  };
      ...
      >
        ...
        <div className='flex w-full flex-col gap-4'>
          <InputForm
            ...
            sendTweet={sendGroupPost} // Changed function reference
