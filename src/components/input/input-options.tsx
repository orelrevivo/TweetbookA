...
//           />
//           {filteredOptions.map(({ name, iconName, disabled }, index) => (
//          <div className='HeroIconnamespan2div hover:bg-main-accent/10 active:bg-main-accent/20'>
//           <div
//           onClick={name === 'Media' || name === 'GIF' ? openFileDialog : () => handleOptionClick(name)}
//           className='HeroIconnamespan3div'>
//           <Button
//               className='HeroIconnamespan2 accent-tab accent-bg-tab p-2 '
//               onClick={name === 'Media' || name === 'GIF' ? openFileDialog : () => handleOptionClick(name)}
//               disabled={disabled}
//               key={name}
//             >
...
//               <ToolTip tip={name} modal={modal} />
//             </Button>
//             <span className='HeroIconnamespan'>{name}</span>
//           </div>
//          </div>
//           ))}
//         </div>
