...
export function Input({
  ...
  return (
    <form
      className={cn('dpsiofuhsewiyfdesfuy8o gap-y-4 px-4 py-3 outline-none duration-200  border-light-border dark:border-dark-border border-1 xs:border flex flex-col', {
        '-mx-4': reply,
        'gap-2': replyModal,
