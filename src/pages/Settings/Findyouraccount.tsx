...
export default function ChangePassword(): JSX.Element {
  ...
  return (
    ...
    <div className="flex">
      ...
      <div className="w-3/4">
      <MainHeader>
      <h1 className='YourAccount'>Find your Tweetbook account</h1>
      <span className='spanYourAccount2'>Enter the email, phone number, or username associated with your account to change your password.</span>
       </MainHeader>
       <br />
       </div>
    </div>
