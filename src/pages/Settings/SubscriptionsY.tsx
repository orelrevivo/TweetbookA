...
const SubscriptionsY = ({ userId, targetUserId }) => {
  ...
  return (
    ...
    <div className="flex">
      ...
      <div className=''>
      <MainHeader>
            <h1 className='YourAccount'>Check back later</h1>
            <span className='spanYourAccount2'>Unfortunately, you don’t meet our eligibility requirements for
            Subscriptions at this time.</span>
      </MainHeader>
      <ul className='list-none'>
        <li className='list-noneText h-[70px]'>
          <span className='gaopuagwg'>Get verified</span>{' '}
          {isVerified ? (
            <span className='gaopuagwg' style={{ color: 'green' }}>
                                <svg
                className='svgclassName72'
          viewBox="0 0 24 24"
          aria-hidden="true"
          style={{
            width: '24px',
        ...
        >
          ...
          <path d="M12 1.75C6.34 1.75 1.75 6.34 1.75 12S6.34 22.25 12 22.25 22.25 17.66 22.25 12 17.66 1.75 12 1.75zm-.81 14.68l-4.1-3.27 1.25-1.57 2.47 1.98 3.97-5.47 1.62 1.18-5.21 7.15z"></path>
            ...
            <span className='gaopuagwg' style={{ color: 'gray' }}>
                                              <svg
                className='svgclassName72'
          viewBox="0 0 24 24"
          aria-hidden="true"
        ...
        <li className='list-noneText h-[70px]'>
          <span className='gaopuagwg'>10 Followers</span>{' '}
        ...
        >
          ...
          <path d="M12 1.75C6.34 1.75 1.75 6.34 1.75 12S6.34 22.25 12 22.25 22.25 17.66 22.25 12 17.66 1.75 12 1.75zm-.81 14.68l-4.1-3.27 1.25-1.57 2.47 1.98 3.97-5.47 1.62 1.18-5.21 7.15z"></path>
              ...
              <span className='gaopuagwg' style={{ color: 'gray' }}>⚪</span>
            )
          ) : (
        ...
        <div className='border-light-border dark:border-dark-border border-1 xs:border'></div>
        <li className='list-noneText h-[70px]'>
        <span className='gaopuagwg'>Be at least 18 years old</span>{' '}
          {yearsold !== null ? ( // Ensure that followerCount has been fetched
            yearsold >= 18 ? (
              <span className='gaopuagwg' style={{ color: 'green' }}>
                                  <svg
                className='svgclassName72'
        ...
        >
          <g>
          <path d="M12 3.75c-4.56 0-8.25 3.69-8.25 8.25s3.69 8.25 8.25 8.25 8.25-3.69 8.25-8.25S16.56 3.75 12 3.75zM1.75 12C1.75 6.34 6.34 1.75 12 1.75S22.25 6.34 22.25 12 17.66 22.25 12 22.25 1.75 17.66 1.75 12z"></path>        </g>
        </svg>
              </span>
            )
          ) : (
...
export default SubscriptionsY;

SubscriptionsY.getLayout = function getLayout(page: ReactElement): ReactNode {
  return (
    <ProtectedLayout>
