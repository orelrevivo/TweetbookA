...
const notifications = () => {
  ...
  return (
    <MainContainer className='gourggrgr_Settings'>
      <div className="flex">
        ...
        <div className="w-3/4">
        <MainHeader>
            <h1 className='YourAccount'>Security</h1>
            <span className='spanYourAccount'>Manage your account’s security.</span>
      </MainHeader>
 ...
 <span>
   <span className='informationAccountSettingsUScss'>
     Help protect your account from unauthorized access by requiring a second <br />authentication method in addition to your Tweetbook password. 
   </span>
   <br />
   <span className='informationAccountSettingsUScss'>
