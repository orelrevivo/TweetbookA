...
import { reauthenticateUser, changePassword } from '../../lib/context/auth-context'; // Assuming the functions are in auth file
...
export default function ChangePassword(): JSX.Element {
  ...
  return (
    ...
    <div className="flex">
      ...
      <div className="w-3/4">
      <MainHeader>
      <h1 className='YourAccount'>Change your password</h1>
      <span className='spanYourAccount2'>If you change your password, you can only log in with the new one.</span>
       </MainHeader>
       <br />
      <label
                  className='inputclassNamepassword group flex items-center justify-between gap-4 rounded-[10px]
                              px-4 py-2 border-light-border dark:border-dark-border border-1 xs:border
      ...
      <button                   className='inputclassNamepassword group flex items-center justify-between gap-4 rounded-[10px]
                              px-4 py-2 border-light-border dark:border-dark-border border-1 xs:border
                             focus-within:ring-2 focus-within:ring-main-accent' onClick={handleSubmit}
                             style={{ width: '95%', height: '50px' , transform: 'translateX(13px)' }}
                             ><p>Save the password change</p></button>
...
// Layout wrapper
ChangePassword.getLayout = function getLayout(page: ReactElement): ReactNode {
  return (
    <ProtectedLayout>
