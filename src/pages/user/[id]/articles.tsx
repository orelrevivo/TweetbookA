...
// Define the Highlight component
const Highlight = () => {
    const [showCardForm, setShowCardForm] = useState(false);
    const [premiumStatus, setPremiumStatus] = useState<boolean | null>(null); // Initialize with null to handle loading state
    ...
    useEffect(() => {
      ...
      checkPremiumStatus(); // Check premium status on component mount
    }, []);
    ...
    // Show loading indicator if premiumStatus is null (still checking status)
    ...
    return (
      <div>
        ...
        <MainHeader title="Articles on your profile" className='Highlight'/>
  
        {!premiumStatus ? (
          // Display this when the user is not subscribed to Premium
          <ul className="list-none">
            <span className="ViewandmanageSubscriptions">
            You must be subscribed to Premium+ to write Articles on Tweetbook
            </span>
            <br />
            <span className="ViewandmanageSubscriptions">
              on your profile.
        ...
        {showCardForm && !premiumStatus && (
          <div className="ViewandmanageSubscriptions22button2 bg-main-search-background px-4 py-2 transition bg-main-sidebar-background">
             <MainHeader title="Subscribe to Premium+" className='Highlight'/>
