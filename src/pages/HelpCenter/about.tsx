  ...
  return (
    <MainContainer>
      <div className="flex">
        ...
        <h1 className='Anything2Dive'>Dive Into Anything</h1>
      <div className='boxV2Anything'>
        <span>
          Tweetbook is home to thousands of communities,
        </span>
        <br />
        <span>
          endless conversation, and authentic human connection.
        </span>
        <br />
        <span>
          Whether you're into breaking news, sports, TV fan theories,
        </span>
        <br />
        <span>
          or a never-ending stream of the internet's cutest animals,
        </span>
        <br />
        <span>
          there's a community on Tweetbook for you.
        </span>
      </div>
