...
const HelpCenter = () => {
  ...
  return (
    <MainContainer>
      ...
      <h1 className='Anything2Dive'>Building a better future with communities</h1>
      <div className='boxV2Anything'>
        <span>
        Tweetbook brings passionate people together to do amazing things. We invest in programs and 
        </span>
        <br />
        <span>
        initiatives that enable, celebrate, and advocate community-driven interests on our platform and in 
        </span>
        <br />
        <span>
        the real world.
